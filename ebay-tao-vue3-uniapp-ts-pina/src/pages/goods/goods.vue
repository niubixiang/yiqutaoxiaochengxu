...
import type { GoodsResult } from '@/types/global'
...
<template>
  <vk-data-goods-sku-popup
    ...
    buy-now-background-color="#d4c026"
    ref="skuPopupRef"
    :actived-style="{
      color: '#d4c026',
      borderColor: '#d4c026',
  ...
  <uni-popup ref="popup" type="bottom" background-color="#fff">
    <ServicePanel v-if="popupName === 'address'" @close="popup?.close()" />
    <AddressPanel v-if="popupName === 'service'" @close="popup?.close()" />
